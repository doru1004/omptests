...
@.offload_maptypes.7 = private unnamed_addr constant [1 x i64] [i64 34]
...
@str.13 = private unnamed_addr constant [8 x i8] c"success\00"
@str.14 = private unnamed_addr constant [3 x i8] c"Hi\00"
@str.15 = private unnamed_addr constant [8 x i8] c"hi alex\00"
...
if.then:                                          ; preds = %entry
  %puts2 = call i32 @puts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.13, i64 0, i64 0))
  br label %if.end
...
omp_if.then:                                      ; preds = %entry
  %puts = tail call i32 @puts(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @str.14, i64 0, i64 0))
  ...
  %12 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @0, i32 %0, i32 1, i64 40, i64 8, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.1*)* @.omp_task_entry..5 to i32 (i32, i8*)*)) #3
  ...
  %20 = call i8* @__kmpc_omp_task_alloc(%struct.ident_t* nonnull @0, i32 %0, i32 1, i64 64, i64 0, i32 (i32, i8*)* bitcast (i32 (i32, %struct.kmp_task_t_with_privates.3*)* @.omp_task_entry..10 to i32 (i32, i8*)*)) #3
...
; Function Attrs: norecurse nounwind
define internal signext i32 @.omp_task_entry..5(i32 signext, %struct.kmp_task_t_with_privates.1* noalias nocapture readonly) #2 {
entry:
  ...
  %4 = load i32, i32* %.idx.val, align 4, !tbaa !3
  %inc.i = add nsw i32 %4, 1
  store i32 %inc.i, i32* %.idx.val, align 4, !tbaa !3
  %puts.i = tail call i32 @puts(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @str.15, i64 0, i64 0)) #3
  ret i32 0
}
...
; Function Attrs: norecurse nounwind
define internal signext i32 @.omp_task_entry..10(i32 signext, %struct.kmp_task_t_with_privates.3* noalias) #2 {
entry:
  ...
  tail call void @__tgt_target_data_end_nowait(i64 -1, i32 1, i8** nonnull %2, i8** nonnull %3, i64* nonnull %4, i64* getelementptr inbounds ([1 x i64], [1 x i64]* @.offload_maptypes.7, i64 0, i64 0)) #3
  ret i32 0
}
